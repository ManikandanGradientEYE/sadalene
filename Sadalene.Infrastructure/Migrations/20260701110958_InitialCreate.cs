        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OtpLogs_Agents_AgentId",
                        column: x => x.AgentId,
                        principalTable: "Agents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OtpLogs_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DivisionId = table.Column<int>(type: "int", nullable: false),
                    FabricComposition = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ...
                    Design = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ...
                    IsBarcodeActive = table.Column<bool>(type: "bit", nullable: false),
                    BarcodeGeneratedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DisplayOrder = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Challans_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SyncSource = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 6, 27, 0, 0, 0, 0, DateTimeKind.Unspecified), "Full bolt fabric ordering", true, "Lump", null },
                    { 2, new DateTime(2026, 6, 27, 0, 0, 0, 0, DateTimeKind.Unspecified), "Cut piece fabric ordering", true, "Cutpack", null },
                    { 3, new DateTime(2026, 6, 27, 0, 0, 0, 0, DateTimeKind.Unspecified), "Box/pieces ordering", true, "Pieces", null },
                    { 4, new DateTime(2026, 6, 27, 0, 0, 0, 0, DateTimeKind.Unspecified), "Custom length ordering", true, "Make to Order", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OtpLogs_AgentId",
                table: "OtpLogs",
                column: "AgentId");

            migrationBuilder.CreateIndex(
                name: "IX_OtpLogs_CustomerId",
                table: "OtpLogs",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_OtpLogs_Phone_OtpCode_IsUsed",
                table: "OtpLogs",
                columns: new[] { "Phone", "OtpCode", "IsUsed" });
